...
String MQTT_HOST = "m14.cloudmqtt.com";
/*
   MQTT host address
*/
String MQTT_PORT = "16896";
/*
   MQTT port
*/
...
void GSM_MQTT::AutoConnect(void)
{
  ...
  */
  connect("rfpudlok", 1, 1, "rfpudlok", "ZOLKJsRlsUHL", 1, 0, 0, 0, "", "");
...
void GSM_MQTT::OnConnect(void)
{
  ...
  */
  //  subscribe(0, _generateMessageID(), "x", 1);
  ...
  */
  ...
  publish(0, 0, 0, _generateMessageID(), "x", "Hello from arduino");
